...
public class JuegoLuchaService {

    private Personaje jugador1;
    private Personaje jugador2; // Constructor para inicializar los personajes

    public JuegoLuchaService(String nombre1, String nombre2) {
